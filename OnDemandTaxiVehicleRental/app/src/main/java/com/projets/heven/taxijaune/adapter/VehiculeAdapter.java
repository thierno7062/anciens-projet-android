...
import com.projets.heven.taxijaune.fragment.BottomSheetFragmentLocation;
import com.projets.heven.taxijaune.model.VehiculePojo;
...
public class VehiculeAdapter extends RecyclerView.Adapter<VehiculeAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        private TextView nom_vehicule, nb_place_vehicule, status_vehicule, prix_vehicule,moreOptions;
...
//        holder.status_vehicule.setText(coursePojo.getStatut());
        holder.prix_vehicule.setText(vehiculePojo.getPrix()+" $");
...
//        });
        ...
        Glide.with(mContext).load(AppConst.Server_urlMain+"assets/images/vehicule/"+vehiculePojo.getImage())
