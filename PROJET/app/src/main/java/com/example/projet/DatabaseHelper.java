...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
       // db.execSQL("CREATE TABLE users (ID INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT)");
        ...
        String sql="CREATE TABLE users(ID INTEGER PRIMARY KEY AUTOINCREMENT,nom TEXT,prenom TEXT,username TEXT," +
              "password TEXT,photo TEXT,adresse TEXT ,telephone INTEGER)";
        String sql2="CREATE TABLE Compte(id INTEGER PRIMARY KEY AUTOINCREMENT,  TIMESTAMP  DEFAULT CURRENT_TIMESTAMP NOT NULL ,id_user INTEGER," +
