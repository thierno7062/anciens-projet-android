        ...
        mService.registerUser(name,email,password)
                .enqueue(new Callback<APIResponse>() {
                    ...
                    public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                        ...
                        if(result.isError())
                            Toast.makeText(InscriptionActivity.this,result.getError_msg(), Toast.LENGTH_SHORT).show();
                        else
                            Toast.makeText(InscriptionActivity.this,"User created : "+result.getUid(),Toast.LENGTH_SHORT).show();
                    }
