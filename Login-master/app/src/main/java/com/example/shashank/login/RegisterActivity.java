...
public class RegisterActivity extends AppCompatActivity {
    ...
    Button Register;
    String NameHolder, EmailHolder, PasswordHolder,phoneHolder,addressHolder;
    ...
    public void InsertDataIntoSQLiteDatabase(){
        ...
        if(EditTextEmptyHolder == true)
        {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO "+SQLiteHelper.TABLE_NAME+" (name,email,password,telephone,adresse) VALUES('"+NameHolder+"', '"+EmailHolder+"', '"+PasswordHolder+"','"+phoneHolder+"','"+addressHolder+"');";
    ...
    public void CheckEditTextStatus(){
        ...
        if(TextUtils.isEmpty(NameHolder) || TextUtils.isEmpty(EmailHolder) || TextUtils.isEmpty(PasswordHolder) || TextUtils.isEmpty(phoneHolder) || TextUtils.isEmpty(addressHolder)){
