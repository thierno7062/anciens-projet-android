...
import com.projets.heven.taxijaune.model.LocationPojo;
...
public class LocationAdapter extends RecyclerView.Adapter<LocationAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
        private TextView nom_vehicule, date, statut_location, prix_total,moreOptions;
        ...
        public void onClick(View v) {
            ...
            if(locationPojo.getStatut().equals("en cours"))
                showMessageAnnuler(String.valueOf(locationPojo.getId()));
        }
    }

    public LocationAdapter(Context mContext, List<LocationPojo> albumList, Activity activity) {
...
//        holder.statut_location.setText(coursePojo.getStatut());
        holder.prix_total.setText(locationPojo.getPrix()+" $");
        String tabDateDebut[] = locationPojo.getDate_debut().split("-");
        String tabDateFin[] = locationPojo.getDate_fin().split("-");

        holder.date.setText(tabDateDebut[2] + " " + MONTHS[Integer.parseInt(tabDateDebut[1])-1] + ". au "+tabDateFin[2] + " " + MONTHS[Integer.parseInt(tabDateFin[1])-1] + ". ");
//        holder.statut_location.setText(tabDateFin[2] + " " + MONTHS[Integer.parseInt(tabDateFin[1])-1] + ". ");
        ...
        if(locationPojo.getStatut().equals("en cours")){
            ...
            holder.statut_location.setTextColor(mContext.getResources().getColor(R.color.colorLogoBlack));
            holder.statut_location.setBackground(mContext.getResources().getDrawable(R.drawable.custom_bg_statut_en_cours));
        }else if(locationPojo.getStatut().equals("accepter")){
            holder.layout_option.setVisibility(View.GONE);
            holder.statut_location.setTextColor(Color.WHITE);
            holder.statut_location.setBackground(mContext.getResources().getDrawable(R.drawable.custom_bg_statut_valide));
        }else if(locationPojo.getStatut().equals("annuler")){
            holder.layout_option.setVisibility(View.GONE);
            holder.statut_location.setTextColor(Color.WHITE);
            holder.statut_location.setBackground(mContext.getResources().getDrawable(R.drawable.custom_bg_statut_annuler));
        }else {
            holder.layout_option.setVisibility(View.GONE);
            holder.statut_location.setTextColor(Color.WHITE);
            holder.statut_location.setBackground(mContext.getResources().getDrawable(R.drawable.custom_bg_statut_execute));
        }
        ...
        Glide.with(mContext).load(AppConst.Server_urlMain+"assets/images/vehicule/"+locationPojo.getImage())
...
//                .error(R.drawable.ic_thumb_placeholder)
    ...
    public void showMessageAnnuler(final String idLocation){
        ...
        builder.setMessage("Voulez-vous annuler votre demande de location de véhicule ?")
                .setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if(connectionDetector.isConnectingToInternet()){
                            ...
                            Toast.makeText(mContext, mContext.getResources().getString(R.string.pas_de_connexion_internet), Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        ...
        protected String doInBackground(final String... params) {
            ...
            StringRequest jsonObjReq = new StringRequest(Request.Method.POST,
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(etat.equals("1")){
                                    ...
                                    Toast.makeText(mContext, mContext.getResources().getString(R.string.annule_avec_succes), Toast.LENGTH_SHORT).show();
                                    delete(getPosition(Integer.parseInt(id_location)));
                                    notifyDataSetChanged();
                                }else{
                                    Toast.makeText(mContext, mContext.getResources().getString(R.string.echec_dannulation), Toast.LENGTH_SHORT).show();
                                    progressdialog.dismiss();
                                }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(mContext, mContext.getResources().getString(R.string.echec_denvoi), Toast.LENGTH_SHORT).show();
                    progressdialog.dismiss();
                }
            }) {
