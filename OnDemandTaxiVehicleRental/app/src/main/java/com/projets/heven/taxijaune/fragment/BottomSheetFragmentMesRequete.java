...
import com.projets.heven.taxijaune.directionhelpers.FetchURLMesRequetes;
...
public class BottomSheetFragmentMesRequete extends BottomSheetDialogFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
...
//    private float note_value = 3f;
    ...
    public BottomSheetFragmentMesRequete() {
        // Required empty public constructor
    }

    public BottomSheetFragmentMesRequete(Activity activity, String statut_course, String distance, String distance_client
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(etat.equals("1")){
                                    ...
                                    RequetePojo requetePojo = FragmentMesRequetes.albumList_mes_requetes.get(Integer.parseInt(position));
                                    requetePojo.setNb_avis(nb_avis);
                                    requetePojo.setNote(niveau);
                                    requetePojo.setMoyenne(moyenne);
                                    FragmentMesRequetes.adapter_mes_requetes.notifyDataSetChanged();
...
//                    Toast.makeText(mContext, "Error", Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        M.setCurrentFragment("mes_requete",context);
        new FetchURLMesRequetes(getActivity()).execute(getUrl(markerDepart.getPosition(), markerDestination.getPosition(), "driving"), "driving");
